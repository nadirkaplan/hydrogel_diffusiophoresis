...
x1,y1 = np.loadtxt('fast_kf_4_19_K_1000_vc_1_eta_0.225_bound_calcium_ca_gel_0.6_refined_mesh_varied_acid_front.txt',unpack=True) #output of the strong_acid_1D_ca.py, total bound copper in 1D gel
...
#plt.ylabel(r'$\phi^{(b)}_{Ca}$')
plt.savefig('rvalue_and_bound_copper_fast_kf_4_19_eta_0.225_ca_gel_0.6_varied_acid_front.png',dpi=300,bbox_inches='tight', pad_inches=0)
plt.show()
