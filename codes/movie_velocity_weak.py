...
#creates stream line profiles by taking velocity fields from weak_acid_2D.mph
...
X = np.loadtxt('velocity_x_weak.txt', comments='%')[:,0] #velocity_x_weak.txt is created by combining velocity_x_weak_0.01.txt and velocity_x_weak_0.05.txt. See Export in weak_acid_2D.mph and combinig_data.py
Y = np.loadtxt('velocity_x_weak.txt', comments='%')[:,1]
U = np.loadtxt('velocity_x_weak.txt', comments='%')[:,2:]
V = np.loadtxt('velocity_y_weak.txt', comments='%')[:,2:] #velocity_y_weak.txt is created by combining velocity_y_weak_0.01.txt and velocity_y_weak_0.05.txt. See Export in weak_acid_2D.mph and combinig_data.py
X_sol = np.loadtxt('sol_vel_x_weak.txt', comments='%')[:,0]#sol_vel_x_weak.txt is created by combining sol_vel_x_weak_0.01.txt and sol_vel_x_weak_0.05.txt. See Export in weak_acid_2D.mph and combinig_data.py
Y_sol = np.loadtxt('sol_vel_x_weak.txt', comments='%')[:,1]
U_sol = np.loadtxt('sol_vel_x_weak.txt', comments='%')[:,2:]
V_sol = np.loadtxt('sol_vel_y_weak.txt', comments='%')[:,2:]#sol_vel_y_weak.txt is created by combining sol_vel_y_weak_0.01.txt and sol_vel_y_weak_0.05.txt. See Export in weak_acid_2D.mph and combinig_data.py
...
def speedplot(n):
    ...
    plt.savefig(f'{n}velocity_weak.png', bbox_inches='tight', pad_inches=0,dpi=300, transparent=True)
    plt.close(fig)
    speed_intp=[]
    V_grid=[]
    U_grid=[]
