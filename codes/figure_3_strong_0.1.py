...
def speedplot(n):
    ...
    plt.savefig('./velocity_strong_0.1_figure_3.png', bbox_inches='tight', pad_inches=0,dpi=300, transparent=True)
    #plt.close(fig)
    speed_intp=[]
    V_grid=[]
    U_grid=[]
...
img1 = plt.imread('velocity_strong_0.1_figure_3.png')
img2 = plt.imread('deform_strong_0.1_figure_3.png.png')
fig, ax =  plt.subplots(figsize=(50,20))
...
plt.savefig('final_t_0.1_strong_0.1_figure_3.png', dpi=300, pad_inches=0, bbox_inches='tight')
#plt.close(fig)
