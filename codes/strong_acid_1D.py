##code for modelling 1D hydrogel exposed to 1M of HCL. Ouputs are solutions for various interested quantities as pvd files.
...
vtkfile_u1 = File('strong_acid_1D/deform.pvd')
vtkfile_u2 = File('strong_acid_1D/phi_o.pvd')
vtkfile_u3 = File('strong_acid_1D/phi_o_hcl.pvd')
vtkfile_u4 = File('strong_acid_1D/phi_a.pvd')
vtkfile_u5 = File('strong_acid_1D/phi_a_hcl.pvd')
vtkfile_u11 = File('strong_acid_1D/phi_b.pvd')
vtkfile_u12 = File('strong_acid_1D/phi_b_hcl.pvd')
vtkfile_u13 = File('strong_acid_1D/Pi.pvd')
vtkfile_u14 = File('strong_acid_1D/du_dt.pvd')
...
np.savetxt('fast_kf_4_19_K_1000_vc_1_eta_0.225_bound_copper_cu_gel_0.6_refined_mesh.txt', flux_net_bound_copper)
np.savetxt('fast_kf_4_19_K_1000_vc_1_eta_0.225_osmotic_pressure_cu_gel_0.6_refined_mesh.txt', flux_os)
