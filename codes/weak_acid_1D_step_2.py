####code for modelling 1D hydrogel exposed to 0.05M of HCL. Ouputs are solutions for various interested quantities as pvd files.
...
(t1,dt1) = np.loadtxt("time_step1_refined_mesh.txt")
...
un_old = Function(V, 'saved_u_step1_refined_mesh.xml')
un1_old, un2_old, un3_old, un4_old, un5_old, un6_old, un7_old = un_old.split();

u0 = Expression(('un1_old', 'un2_old', 'un3_old', 'un4_old', 'phiac_hcl2*0.5*(1-tanh(125*(x[0]-0.96)))', 'un6_old', 'un7_old'), degree=1, phiac = phiac, phiac_hcl2 = phiac_hcl2, un1_old=un1_old, un2_old=un2_old, un3_old=un3_old, un4_old=un4_old, un6_old=un6_old, un7_old=un7_old)
un = interpolate(u0, V)
...
vtkfile_u1 = File('slow_kf_4_19_K1000_vc_1_eta_0.225_ini_0.96_cu_gel_0.6_step2_long_refined_mesh/deform.pvd')
vtkfile_u2 = File('slow_kf_4_19_K1000_vc_1_eta_0.225_ini_0.96_cu_gel_0.6_step2_long_refined_mesh/phi_o.pvd')
vtkfile_u3 = File('slow_kf_4_19_K1000_vc_1_eta_0.225_ini_0.96_cu_gel_0.6_step2_long_refined_mesh/phi_o_hcl.pvd')
vtkfile_u4 = File('slow_kf_4_19_K1000_vc_1_eta_0.225_ini_0.96_cu_gel_0.6_step2_long_refined_mesh/phi_a.pvd')
vtkfile_u5 = File('slow_kf_4_19_K1000_vc_1_eta_0.225_ini_0.96_cu_gel_0.6_step2_long_refined_mesh/phi_a_hcl.pvd')
vtkfile_u11 = File('slow_kf_4_19_K1000_vc_1_eta_0.225_ini_0.96_cu_gel_0.6_step2_long_refined_mesh/phi_b.pvd')
vtkfile_u12 = File('slow_kf_4_19_K1000_vc_1_eta_0.225_ini_0.96_cu_gel_0.6_step2_long_refined_mesh/phi_b_hcl.pvd')
vtkfile_u13 = File('slow_kf_4_19_K1000_vc_1_eta_0.225_ini_0.96_cu_gel_0.6_step2_long_refined_mesh/Pi.pvd')
...
np.savetxt('slow_kf_4_19_K1000_vc_1_eta_0.225_ini_0.96_cu_gel_0.6_step2_long_refined_mesh.txt', flux_net_bound_copper)
np.savetxt('slow_kf_4_19_K_1000_vc_1_eta_0.225_osmotic_pressure_cu_gel_0.6_step2_long_refined_mesh.txt', flux_os)
